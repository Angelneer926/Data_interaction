...
function bisector_default(f) {
  ...
  function left2(a3, x4, lo, hi) {
    ...
    while (lo < hi) {
      const mid = lo + hi >>> 1;
      if (compare(a3[mid], x4) < 0) lo = mid + 1;
      else hi = mid;
    }
    return lo;
  }
...
function x_default2(x4) {
  ...
  if (typeof x4 !== "function") x4 = constant_default8(x4 == null ? 0 : +x4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
function y_default2(y4) {
  ...
  if (typeof y4 !== "function") y4 = constant_default8(y4 == null ? 0 : +y4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
