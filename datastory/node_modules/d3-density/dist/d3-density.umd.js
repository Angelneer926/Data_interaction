(function (global, factory) {
  ...
  (factory((global['d3-density'] = global['d3-density'] || {}),global.d3));
  ...
  function density(container) {
    ...
    density.zoom = function (_) {
      return arguments.length ? (zoom = _, density) : zoom;
    };
    ...
    function density() {
      ...
      var densityCurve = d3.line().curve(curve).x(function (d) {
        return scaleX(d[0]);
      }).y(function (d) {
        return scaleY(d[1]);
      });
